...
class SpinnerPicker {
    ...
    constructor(canvas, valueHandler, config, onchanged=null) {
        ...
        this.selectionColor = (config != null && "selection_color" in config)?config["selection_color"]:"#ffeb3b";
    ...
    updateView() {
        ...
        this.drawPolygon([[0, 0], [this.canvas.width, 0], [this.canvas.width, hBoxSize * 3], [0, hBoxSize * 3]], "transparent");
        this.drawPolygon([[0, hBoxSize * 4], [this.canvas.width, hBoxSize * 4], [this.canvas.width, this.canvas.height], [0, this.canvas.height]], "transparent");
